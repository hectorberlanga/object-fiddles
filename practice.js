...
favoriteThings.brand = "my Brand";  //Code here
...
for (var values in states) {
  if (states[values] > 30000) {
    alert(states[values]);
  }
}  //Code Here
...
user1.name = "Hector";
user1.username = "Hector1111";
user1.pwHash = "a;lsdkfj";  //Code Here
...
function bindCard (person, creditCard){
  var newObject = {};
    for (var attrname in person) {newObject[attrname] = person[attrname];}
    for (var attrname in creditCard) {newObject[attrname] = creditCard[attrname];}
  return newObject;
}  //Code Here
